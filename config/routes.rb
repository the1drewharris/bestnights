Bestnights::Application.routes.draw do
  ...
  match 'addproperty' => "home#welcome", :as => :addproperty, :via => :get
  ...
  match 'print_reservation_data_month' => "dashboard#print_reservation_data_month", :as => 'print_reservation_data_month'
  ...
  match '/registerhotel' => 'home#landing', :as => 'registerhotel'  
  match 'create_contact' => "home#create_contact", :as => :create_contact, :via => :post
  match '/get_room_info' => 'rooms#get_room_info', :as => 'get_room_info', :via => :get
