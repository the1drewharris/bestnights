class HomeController < ApplicationController
  ...
  def book(traveler, amount, cardnumber,ccv, cardtype, hotel, booking_number, booking_created_on, checkin, checkout, room_ids, room_type)
    ...
    File.open("#{Rails.root.to_s}/public/fax_content.html", 'wb') do|f|
      f.write("<html>"+"<body>"+@image+"<br /><br />"+'Hotel Name'+' : '+"<strong>"+hotel.name+"</strong><br /><br />"+'Traveler Name'+' : '+"<strong>"+traveler.name+"</strong><br /><br />"+'Traveler Email'+' : '+"<strong>"+traveler.email+"</strong><br /><br />"+'Booking Number'+' : '+"<strong>"+booking_number.to_s+"</strong><br /><br />"+'Booked On'+' : '+"<strong>"+booking_created_on.to_s+"</strong><br /><br />"+'Card Number'+' : '+"<strong>"+traveler.credit_card_number+"</strong><br /><br />"+'Card Type'+' : '+"<strong>"+traveler.credit_card_type+"</strong><br /><br />"+'Address'+' : '+"<strong>"+traveler.address1+"</strong><br /><br />"+'Amount'+' : '+"<strong>"+"#{amount}"+"</strong><br /><br />"+'Checkin Date'+' : '+"<strong>"+checkin.to_s+"</strong><br /><br />"+'Checkout Date'+' : '+"<strong>"+checkout.to_s+"</strong><br /><br />"+'Room Number'+' : '+"<strong>"+"#{room_ids}"+"</strong><br /><br />"+'Room Type'+' : '+"<strong>"+"#{room_type}"+"</strong><br /><br />"+@disclaimer+"</body>"+"</html>")
    end
    results = []
    chars = 0
    data = ""
